    ...
    <div className="p-4 sm:p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
        {cars.map((car) => (
          <div
            key={car.id}
            className={`border rounded-lg p-3 sm:p-4 cursor-pointer transition-all ${selectedCarId === car.id
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-bold text-base sm:text-lg">{car.marca} {car.modelo}</h3>
                <p className="text-gray-600 text-sm sm:text-base">{car.anio} • {car.placa}</p>
              </div>
              <span className={`px-2 py-1 text-xs rounded-full ${car.estado === 'DISPONIBLE'
      ...
      {selectedCar ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-3 sm:space-y-4">
              <div className="bg-gray-50 p-3 sm:p-4 rounded">
                <h3 className="font-medium text-gray-700 mb-1 sm:mb-2">Información del Vehículo</h3>
              ...
              <div className="bg-gray-50 p-3 sm:p-4 rounded">
                <h3 className="font-medium text-gray-700 mb-1 sm:mb-2">Ubicación</h3>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className={`p-3 sm:p-4 rounded ${selectedCar.estado === 'DISPONIBLE'
                  ? 'bg-green-50 border-green-200'
                  : selectedCar.estado === 'RESERVADO'
                    ? 'bg-yellow-50 border-yellow-200'
                    : 'bg-red-50 border-red-200'
                } border`}>
                <h3 className="font-medium text-gray-700 mb-1 sm:mb-2">Estado Actual</h3>
              ...
              <div className="bg-yellow-50 p-3 sm:p-4 rounded border border-yellow-100">
                <h3 className="font-medium text-gray-700 mb-1 sm:mb-2">Características</h3>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg text-center text-sm sm:text-base text-gray-500">
